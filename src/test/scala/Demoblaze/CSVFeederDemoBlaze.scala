...
class CSVFeederDemoBlaze extends Simulation {
  ...
  val csvFeeder = csv("src/test/scala/data/gameScvFile.csv").circular
...
// Injects users at a constant rate, Users will be injected at regular intervals.
