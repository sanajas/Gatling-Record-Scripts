...
stats: {
    ...
    },"req_get-all-userid--b1c2b": {
        type: "REQUEST",
        name: "Get all userid which was saved in variable and compare the value ",
path: "Get all userid which was saved in variable and compare the value ",
pathFormatted: "req_get-all-userid--b1c2b",
stats: {
    "name": "Get all userid which was saved in variable and compare the value ",
    "numberOfRequests": {
        "total": "1",
